...
# renovate: datasource=git-refs depName=oae/gnome-shell-pano packageName=https://github.com/oae/gnome-shell-pano versioning=loose packageVersionTemplate=master
