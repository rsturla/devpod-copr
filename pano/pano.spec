...
# renovate: datasource=git-refs depNameTemplate=oae/gnome-shell-pano packageName=https://github.com/oae/gnome-shell-pano versioning=loose packageVersionTemplate=master
